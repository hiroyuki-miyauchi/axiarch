...
| File | Description |
|:-----|:------------|
| `universal/security/000_security_privacy.md` | Security & Privacy Standards |
| `universal/security/100_data_governance.md` | Data Governance Standards |
| `universal/security/200_oss_compliance.md` | OSS Compliance Standards |
| `universal/security/300_ip_due_diligence.md` | IP Due Diligence |
