...
-   **Mandate**:
    ...
    3.  **Cross-Border Transfer Alignment**: For EU resident user data transfers outside the EU, and for transfers abroad subject to other applicable jurisdictions (e.g., Japan under APPI), document appropriate legal bases (SCCs, adequacy decisions, etc.).
