...
> **Context**: 2023年10月の景表法改正（日本のステルスマーケティング規制）、米国FTC Endorsement Guides、および同様の法域の規制等により、インフルエンサーマーケティングの透明性要件が厳格化。違反は行政処分・ブランド毀損の対象。
...
*   **The Ad Creative Policy Protocol**:
    *   **Prohibition List**:
        - 根拠のない最上級表現（例: 「[市場]No.1」「業界No.1」等、第三者認定なき使用）
