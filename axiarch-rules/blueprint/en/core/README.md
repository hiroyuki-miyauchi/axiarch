...
| File | Description |
|:-----|:------------|
| `universal/{lang}/core/000_core_mindset.md` | Core Philosophy & Mindset |
| `universal/{lang}/core/100_governance.md` | Governance Protocol |
| `universal/{lang}/core/200_language_protocol.md` | Language Protocol |
