...
> **参考規格**: ISO 31700, GDPR Art.25, APPI, CCPA/CPRA
...
-   **Law**: ログ出力・エラーレポート・サポート画面にPIIを**絶対に含めない**。
-   **Action**:
...
-   **Action**:
    1.  サービス提供地域のデータ保護法（GDPR, APPI, CCPA等）を特定。
...
-   **Action**:
    ...
    4.  **コンプライアンス態勢評価**: GDPR/APPI/CCPA等の要件に対する現在の遵守状況をスコアリング。
...
| **APPI** | 日本 | 利用目的の公表・通知 | あり（開示・訂正・利用停止） | 速やかに |
...
-   **Law**: `localStorage` / `sessionStorage` にシークレット・トークン・PIIを**絶対に保存しない**。
...
> **参考規格**: EU AI Act, NIS2, DORA, GDPR, APPI
...
| 要件 | GDPR | APPI | NIS2 | DORA | EU AI Act |
|:-----|:----:|:----:|:----:|:----:|:---------:|
| データ保護影響評価 | ✅ | — | — | — | ✅ (高リスク) |
