...
1. [§1. 戦略的柱](#1-戦略的柱-strategic-pillars---c-level-alignment)
2. [§2. 財務・コスト管理](#2-財務コスト管理-finance--cost-management---cfo-view)
3. [§3. 組織・人事観点](#3-組織人事観点-hr--organization---human-capital-view)
4. [§4. 収益化戦略](#4-収益化戦略-monetization-strategy)
5. [§5. ユニットエコノミクス](#5-ユニットエコノミクス-unit-economics)
6. [§6. 法務・コンプライアンス観点](#6-法務コンプライアンス観点-legal--compliance-perspective)
7. [§7. 組織DNAフレームワーク](#7-組織dnaフレームワーク-organizational-dna-frameworks)
8. [§8. 検索・発見アーキテクチャ](#8-検索発見アーキテクチャ-search--discovery-architecture)
9. [§9. レビュー・信頼性システム](#9-レビュー信頼性システム-review--trust-system)
10. [§10. インタラクティブエンジン](#10-インタラクティブエンジン-interactive-engine)
...
*   **Day 1 Philosophy**:
    *   顧客への執着、結果へのコミットメント、高速な意思決定。大企業病（Day 2）を徹底して低減します。
...
| キーワード | 対応セクション |
|---|---|
| MVP・PMF・North Star・Exit戦略 | §1 戦略的柱 |
| ペルソナ・ロードマップ・ICE | §1.2, §1.3 |
| ROI・バーンレート・SaaS | §2 財務管理 |
| AIチーム・Keeper Test・心理的安全性 | §3 組織 |
| フリーミアム・サブスク・広告 | §4 収益化 |
| LTV・CAC・解約率・マジックナンバー | §5 ユニットエコノミクス |
| 利用規約・Consumer Protection Laws・Financial Regulations | §6 法務 |
| タグ・営業時間・検索スコア | §8 検索アーキテクチャ |
| ベイズ平均・モデレーション・スパム | §9 レビューシステム |
| 投票・クイズ・アンケート | §10 インタラクティブ |

### クロスリファレンス（セクション → 関連ルール）

| セクション | 関連 Universal ルール |
|---|---|
| §1 戦略的柱 | `000_core_mindset`, `101_revenue_monetization` |
| §2 財務管理 | `720_cloud_finops`, `101_revenue_monetization` |
| §3 組織 | `000_core_mindset` |
| §4 収益化 | `101_revenue_monetization`, `301_api_integration` |
| §5 ユニットエコノミクス | `101_revenue_monetization`, `102_growth_marketing` |
| §6 法務 | `600_security_privacy`, `601_data_governance` |
| §8 検索アーキテクチャ | `320_supabase_architecture`, `300_engineering_standards` |
| §9 レビューシステム | `600_security_privacy`, `400_ai_engineering` |
| §10 インタラクティブ | `320_supabase_architecture` |
