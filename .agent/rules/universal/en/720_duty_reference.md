...
> - **Requirement**: AI Agents and Developers MUST refer to and understand relevant rules in `.agent/rules/` before executing any task.
> - **Action**:
...
*   **Law**: `.agent/rules/blueprint/` is not "reference material" but **part of the Code (Logic)**.
