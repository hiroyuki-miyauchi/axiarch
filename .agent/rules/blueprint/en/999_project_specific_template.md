# 99. Project Specific Rules Template

> [!TIP]
> This file is intended to be copied to the `.agent/rules/blueprint/` directory for use. Rename it to `010_project_rules.md` or similar.
