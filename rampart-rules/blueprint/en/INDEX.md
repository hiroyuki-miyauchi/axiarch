...
- [998. Feature Specification Template](998_feature_spec_template.md) - **Feature spec template (SDD core)**. Defines acceptance criteria, data model, API design, and test strategy per feature. Copy to Category 600–800 for use.
- [999. Project Specific Template](999_project_specific_template.md) - Template for adding project-specific rule files.
...
### Adding Feature Specifications (Blueprint First in Practice)
1. **Copy `998_feature_spec_template.md`**
2. Rename following Category 600–800 numbering (e.g., `600_feature_payment.md`)
3. **Write §3 Acceptance Criteria first** — Implementation MUST NOT begin with this section empty
4. Complete remaining sections (Data Model, API Design, Test Strategy, etc.)
5. **Add an entry to Category 600–800 in this file (INDEX.md)**

### Adding Project-Specific Rules
1. Copy `999_project_specific_template.md`
2. Rename following the category numbering above (e.g., `100_security_policy.md`)
...
- Mandatory reflection based on the "Continuous Improvement" process in `AGENTS.md`
...
| Feature spec template, acceptance criteria, Given/When/Then | `998_feature_spec_template.md` |
| Project-specific rule template | `999_project_specific_template.md` |
