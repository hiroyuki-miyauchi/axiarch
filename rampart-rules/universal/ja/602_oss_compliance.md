...
→ クロスリファレンス: [`601_data_governance.md`](./601_data_governance.md) §GenAI著作権
...
→ クロスリファレンス: [`600_security_privacy.md`](./600_security_privacy.md) §サプライチェーンセキュリティ
...
→ クロスリファレンス: [`601_data_governance.md`](./601_data_governance.md) §GenAI著作権、[`400_ai_engineering.md`](./400_ai_engineering.md)
...
→ クロスリファレンス: [`600_security_privacy.md`](./600_security_privacy.md) §サプライチェーン
...
→ クロスリファレンス: [`200_design_ux.md`](./200_design_ux.md)
...
→ クロスリファレンス: [`300_engineering_standards.md`](./300_engineering_standards.md) §CI/CD
...
→ クロスリファレンス: [`601_data_governance.md`](./601_data_governance.md) §EU Data Act
...
→ クロスリファレンス: [`600_security_privacy.md`](./600_security_privacy.md) §サプライチェーン、[`300_engineering_standards.md`](./300_engineering_standards.md) §CI/CD
...
→ クロスリファレンス: [`340_web_frontend.md`](./340_web_frontend.md) §パフォーマンス予算
...
→ クロスリファレンス: [`603_ip_due_diligence.md`](./603_ip_due_diligence.md) §IP資産管理
...
- **ルール**: ポストモーテムの結果を教訓ログ（`010_project_lessons_log.md`）に記録する
...
→ クロスリファレンス: [`503_incident_response.md`](./503_incident_response.md)、[`600_security_privacy.md`](./600_security_privacy.md)
...
→ クロスリファレンス: [`401_data_analytics.md`](./401_data_analytics.md)
...
→ クロスリファレンス: [`101_revenue_monetization.md`](./101_revenue_monetization.md) §FinOps
...
→ クロスリファレンス: [`600_security_privacy.md`](./600_security_privacy.md) §脆弱性管理
...
→ クロスリファレンス: [`600_security_privacy.md`](./600_security_privacy.md) §暗号化ポリシー、[`601_data_governance.md`](./601_data_governance.md) §量子暗号アジリティ
...
→ クロスリファレンス: [`601_data_governance.md`](./601_data_governance.md)、[`603_ip_due_diligence.md`](./603_ip_due_diligence.md)
...
→ クロスリファレンス: [`400_ai_engineering.md`](./400_ai_engineering.md)、[`601_data_governance.md`](./601_data_governance.md) §GenAI著作権
...
→ クロスリファレンス: [`502_site_reliability.md`](./502_site_reliability.md) §オブザーバビリティ
...
→ クロスリファレンス: §8 SBOM規制コンプライアンス、[`503_incident_response.md`](./503_incident_response.md)
...
> **クロスリファレンス（関連ルールファイル）**:
> - [`600_security_privacy.md`](./600_security_privacy.md) — サプライチェーンセキュリティ、シークレット管理、暗号化ポリシー
> - [`601_data_governance.md`](./601_data_governance.md) — GenAI著作権、EU Data Act、量子暗号アジリティ
> - [`603_ip_due_diligence.md`](./603_ip_due_diligence.md) — 知的財産管理、デューデリジェンス
> - [`300_engineering_standards.md`](./300_engineering_standards.md) — CI/CD、コーディング規約
> - [`340_web_frontend.md`](./340_web_frontend.md) — パフォーマンス予算、バンドルサイズ
> - [`400_ai_engineering.md`](./400_ai_engineering.md) — AI実装、モデル管理
> - [`502_site_reliability.md`](./502_site_reliability.md) — オブザーバビリティ、ランタイム監視
> - [`503_incident_response.md`](./503_incident_response.md) — インシデント対応フロー
> - [`101_revenue_monetization.md`](./101_revenue_monetization.md) — FinOps
> - [`200_design_ux.md`](./200_design_ux.md) — フォント・アセット管理
> - [`401_data_analytics.md`](./401_data_analytics.md) — KPIダッシュボード
