...
>
> **Target**: Entire project (source code + `rampart-rules/`)
>
...
2.  **Target 1: The Constitution (Supreme Law)**
    ...
    * **Class S (Universal)**: Under `rampart-rules/universal/` → **Read-Only (modification prohibited)**
...
3.  **Target 2: Project Lessons**
    ...
    * **Class A (Blueprint)**: Under `rampart-rules/blueprint/` → **Read/Write (update target)**
