...
bash axiarch-scripts/axiarch-upgrade.sh --to v1.15.0 --safe-only --apply

# Codex向けに必要なものだけ対象化 / Scope to Codex-oriented files
bash axiarch-scripts/axiarch-upgrade.sh --to v1.15.0 --agent codex --dry-run
