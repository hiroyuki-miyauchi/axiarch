...
*   **デジタル5S (Digital 5S)**:
    ...
    *   **The Dependency Governance Protocol**:
        ...
        *   **The License Quarantine (AGPL Block)**: ライセンスガバナンスの詳細については、`600_security_privacy.md` の Rule 5 を参照し、**AGPL (Affero GPL)** の使用防止を徹底してください。
...
*   **プルリクエスト (Pull Requests)**:
    ...
    *   **Supreme Directive: The AI Git Ban (Refer to 00)**:
        *   **Ref**: AIによるGit操作の絶対禁止については、最高法規 `000_core_mindset.md` の Rule 8.1 を参照し、これを厳守してください。
...
| キーワード | セクション | 関連ルール |
|-----------|----------|-----------|
| ネーミング / kebab-case | §1 | `340_web_frontend`, `342_mobile_flutter` |
| パフォーマンス / LCP / CWV | §2 | `340_web_frontend`, `502_site_reliability` |
| DevSecOps / セキュリティ | §3 | `600_security_privacy`, `601_data_governance` |
| 技術的負債 | §4 | `720_cloud_finops` |
| AIファースト / コードレビュー | §5 | `400_ai_engineering` |
| グリーンコーディング | §6 | `720_cloud_finops` |
| ゼロバグ・ポリシー | §7 | `700_qa_testing`, `503_incident_response` |
| Git / バージョン管理 | §10 | `502_site_reliability` |
| ドキュメント運用 | §11 | `500_internal_tools` |
