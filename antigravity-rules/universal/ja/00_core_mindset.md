...
*   **全てのユーザーと文脈 (All Users & All Contexts)**:
    ...
    *   システムUI、エラーメッセージ、ヘルプ、利用規約、プライバシーポリシーなど、**ユーザーの目に触れる全ての情報**は、自然で、温かみがあり、かつ法的に正確な日本語でなければなりません。
*   **開発プロセス**:
    *   コミットメッセージ、PR、コードコメント、AIからの提案も全て**日本語**で行います。
    *   「英語で作り（コード）、日本語で説明する（ドキュメント・UI）」が鉄則です。
