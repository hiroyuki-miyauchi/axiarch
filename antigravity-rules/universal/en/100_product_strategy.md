...
1. [§1. Strategic Pillars](#1-strategic-pillars---c-level-alignment)
2. [§2. Finance & Cost Management](#2-finance--cost-management---cfo-view)
3. [§3. HR & Organization](#3-hr--organization---human-capital-view)
4. [§4. Monetization Strategy](#4-monetization-strategy)
5. [§5. Unit Economics](#5-unit-economics)
6. [§6. Legal & Compliance](#6-legal--compliance-perspective)
7. [§7. Organizational DNA Frameworks](#7-organizational-dna-frameworks)
8. [§8. Search & Discovery Architecture](#8-search--discovery-architecture)
9. [§9. Review & Trust System](#9-review--trust-system)
10. [§10. Interactive Engine](#10-interactive-engine)
...
| Keyword | Section |
|---|---|
| MVP, PMF, North Star, Exit strategy | §1 Strategic Pillars |
| Persona, roadmap, ICE | §1.2, §1.3 |
| ROI, burn rate, SaaS | §2 Finance |
| AI team, Keeper Test, psychological safety | §3 Organization |
| Freemium, subscription, ads | §4 Monetization |
| LTV, CAC, churn rate, magic number | §5 Unit Economics |
| Terms of service, legal compliance | §6 Legal |
| Tags, business hours, search score | §8 Search Architecture |
| Bayesian average, moderation, spam | §9 Review System |
| Poll, quiz, survey | §10 Interactive |

### Cross-References (Section → Related Rules)

| Section | Related Universal Rules |
|---|---|
| §1 Strategic Pillars | `000_core_mindset`, `101_revenue_monetization` |
| §2 Finance | `720_cloud_finops`, `101_revenue_monetization` |
| §3 Organization | `000_core_mindset` |
| §4 Monetization | `101_revenue_monetization`, `301_api_integration` |
| §5 Unit Economics | `101_revenue_monetization`, `102_growth_marketing` |
| §6 Legal | `600_security_privacy`, `601_data_governance` |
| §8 Search Architecture | `320_supabase_architecture`, `300_engineering_standards` |
| §9 Review System | `600_security_privacy`, `400_ai_engineering` |
| §10 Interactive | `320_supabase_architecture` |
