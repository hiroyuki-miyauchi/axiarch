...
> - **Core Principle**: All communication between users and developers must be conducted in the language defined by `Project Native Language` in `GEMINI.md`. Advanced language proficiency including cultural context and nuance is required.
...
- **Rule 74.1**: Every project MUST define **one authoritative language** via `Project Native Language` in `GEMINI.md`
...
- **Rule 74.20**: Blueprints (under `antigravity-rules/blueprint/`) MUST be written in the **Project Native Language**
