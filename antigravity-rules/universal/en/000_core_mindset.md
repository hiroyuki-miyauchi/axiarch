...
>
> 1.  These documents (`antigravity-rules/universal/*.md`) are the **Supreme Law** of this project's development, operations, and business.
...
2. [§1. The Antigravity Mindset](#1-the-antigravity-mindset)
...
*   **Universal Rules (Immutable)**: `antigravity-rules/universal/` is the DNA of Google Antigravity. No unauthorized changes are allowed.
...
| Zero tolerance, bugs, zero warnings | §1 Antigravity Mindset |
