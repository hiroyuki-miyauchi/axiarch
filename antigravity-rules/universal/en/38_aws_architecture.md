...
*   **Action**:
    1.  **Mandatory Tags**: Require the following tags on all resources:
        ...
        | `Project` | Project ID | `inucomi`, `admin-portal` |
...
*   **Cross-Ref**: User support email in `51_user_support.md`.
...
*   **Cross-Ref**: AI implementation in `40_ai_implementation.md`. Connect in §84.
...
> **Purpose**: Reverse lookup index for instantly finding rules for target services across 141 sections and 210+ rules.

| AWS Service | Related Sections |
|:------------|:-----------------|
| **IAM / Identity Center / STS / ABAC** | §1, §22, §44, §60, §102 |
| **VPC / Subnet / Security Group / Block Public Access** | §2, §2.8, §30, §51, §92, §94 |
...
| **ECS / EKS / Fargate / EKS Auto Mode** | §3.3, §13, §70, §105 |
| **App Runner** | §3.5 |
| **ECR** | §13, §122 |
...
| **CodeCatalyst** | §123 |
| **Cost Explorer / Budgets / FinOps** | §9, §37, §56, §74, §112 |
...
| **SES** | §124 |
| **Lex** | §135 |
| **Organizations / Control Tower / SCP / RCP** | §0.4, §14.2, §26, §50, §68 |
| **WAF / Shield / Network Firewall** | §72, §94 |
...
| **Outposts / Local Zones / Wavelength** | §97 |
...
- **Network Hub**: §130 (Transit Gateway) → §131 (Direct Connect) → §2 (VPC) → §92 (PrivateLink)
...
- **Supabase Backend**: `37_supabase_architecture.md` — BaaS strategy, RLS, Edge Functions
- **Security & Privacy**: `60_security_privacy.md` — Zero Trust, OWASP Top 10
- **SRE & Reliability**: `52_sre_reliability.md` — 99.99% availability, chaos engineering, load testing
- **API Integration**: `35_api_integration.md` — REST/GraphQL design, Rate Limiting
- **Engineering General**: `30_engineering_general.md` — Code review, testing strategy
- **AI Implementation**: `40_ai_implementation.md` — Streaming-first, RAG design, token cost management
