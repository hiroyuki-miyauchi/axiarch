...
> [!TIP]
> This file is intended to be copied to the `antigravity-rules/blueprint/` directory for use. Rename it following the category numbering bands (e.g., `100_security_policy.md`).
